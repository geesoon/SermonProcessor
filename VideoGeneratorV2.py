...
class VideoGeneratorV2:
    ...
    def generate_video_file(self, file_name):
        ...
        video_with_audio = ImageClip(
            self.output_dir + "background/" + file_name + ".jpg").set_duration(
                audio.duration).set_fps(1).set_audio(audio)
    ...
    def generate_video_static_background_image(self, audio_metadata,
                                               file_name):
